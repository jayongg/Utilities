Game bar loader - just something quick to load up the game bar when in Windows 10 Tablet mode.  Right now Windows 10 doesn't let you load the game bar without a keyboard!

You'd have to create your own shortcuts to make use of this.

Instructions:
GameBarLoader.exe
no parameters: load up game bar
s: take a screenshot after a second
r: start recording
g: "record that"


This depends on the Windows Input Simulator at InputSimulator.codeplex.com. I've included it here for convenience.

Readme for input simulator below:
